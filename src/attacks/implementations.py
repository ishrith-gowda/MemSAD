...
from .base import Attack, AttackDefensePair
...
class AgentPoisonAttack(Attack):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.attack_type = "agent_poison"
        self.poison_types = self.config.get("poison_types", [
            "content_corruption",
            "false_memories", 
    ...
    def execute(self, target_content: Any, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            execution_time = time.time() - start_time
            self.logger.log_error("agent_poison_execute", e, {
                "target_content": str(target_content)[:100]
            })
...
class MINJAAttack(Attack):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        """
        super().__init__(config)
        self.attack_type = "minja"
        self.injection_types = self.config.get("injection_types", [
            "direct_injection",
            "stealth_injection",
            "cascade_injection"
        ])
    ...
    def execute(self, target_content: Any, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            execution_time = time.time() - start_time
            self.logger.log_error("minja_execute", e, {
                "target_content": str(target_content)[:100]
            })
    ...
    def _cascade_injection(self, content: Any) -> Any:
        ...
        if isinstance(content, str):
            ...
            return {
                "content": content,
                "cascade_references": cascade_links[:2]
            }
...
class InjecMEMAttack(Attack):
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        """
        super().__init__(config)
        self.attack_type = "injecmem"
        self.manipulation_types = self.config.get("manipulation_types", [
            "content_replacement",
            "backdoor_insertion",
            "trigger_activation"
        ])
    ...
    def execute(self, target_content: Any, **kwargs) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.log_attack_execution(
                self.attack_type,
                {"manipulation_type": manipulation_type, "persistence": self.persistence_level}
            )
            ...
            execution_time = time.time() - start_time
            self.logger.log_error("injecmem_execute", e, {
                "target_content": str(target_content)[:100]
            })
    ...
    def execute_all(self, target_content: Any, **kwargs) -> Dict[str, Any]:
        ...
        for attack_type, attack in self.attacks.items():
            try:
                ...
                self.logger.log_error("attack_suite_execute", e, {
