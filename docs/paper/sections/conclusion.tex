...
passages with high query alignment), \sad{} achieves $\tpr \approx 1.00$; for
\injecmem{}, $\tpr \approx 0.20$.  \sad{} achieves near-zero TPR against
\agentpoison{} when calibrated on un-triggered victim queries, because the centroid
passage falls within the benign similarity distribution in this setting.
