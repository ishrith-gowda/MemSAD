...
\minja{} achieves $\asrr=0.65$, approaching the paper-reported target
of $\geq0.70$; the small gap is attributable to our 200-entry corpus
and the absence of full natural-language bridging-step generation (our
simulation uses template-based passages).
