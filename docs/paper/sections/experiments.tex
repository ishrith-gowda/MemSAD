...
\begin{figure}[t]
  ...
  \caption{Multi-agent epidemic propagation ($N$=10 agents,
           $p_{\mathrm{re\text{-}store}}$=0.5, 3 initial poison entries) for each
           attack type.
           Red: undefended spread (fraction of agents exposed); bars:
           cumulative secondary poison entries from re-storage.
           Green: \sad{} quarantine halts propagation entirely by blocking
           poisoned entries at the ingestion gate.
           \agentpoison{} reaches 100\% spread by step 3; \minja{} by step 5;
           \injecmem{} shows gradual escalation over 15 steps.}
