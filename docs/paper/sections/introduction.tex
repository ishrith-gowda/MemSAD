...
\begin{enumerate}
  ...
  greedy synonym substitution to craft evasive passages.  We prove and
  empirically confirm a fundamental tension: any reduction in anomaly score
  (for evasion) also reduces retrieval rank (for attack effectiveness),
  since both depend on the same cosine similarity measure.  The adaptive
  adversary achieves at most 60\% evasion rate at the cost of $\geq 0.40$
  ASR-R degradation, confirming \sad{}'s structural robustness.
