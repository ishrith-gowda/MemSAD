...
\item {\bf Experimental setting/details}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Section~\ref{sec:experiments} and Appendix~\ref{app:ablation} specify all hyperparameters: $\kappa=2.0$ for \memsad{}, $z_{\mathrm{thr}}=4.0$ for watermark, $\tau=0.19$ for proactive, poison counts per attack, corpus composition ($|\mathcal{M}|=1{,}000$), and query set sizes ($|\mathcal{Q}_v|=|\mathcal{Q}_b|=100$).
