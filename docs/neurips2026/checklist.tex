...
\item {\bf Limitations}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Section~\ref{sec:discussion} includes a dedicated limitations paragraph covering corpus size, query distribution stationarity, the synonym loophole, encoder sensitivity, and compound exposure independence assumptions.
