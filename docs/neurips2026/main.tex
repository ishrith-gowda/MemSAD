...
\noindent \memsad{} achieves reliable detection with $N = O(\log(1/\delta)/\rho^2)$ (Theorem~\ref{thm:calibration_bound}), matching the $\Omega(1/\rho^2)$ lower bound up to $\log(1/\delta)$---establishing minimax optimality via Le Cam's method~\citep{lecam1973convergence}.
