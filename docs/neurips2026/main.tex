...
(ii)~Regret bound assumes slow drift; abrupt distribution shifts degrade calibration. An adversary who can inject benign-looking entries into $\cM_{\text{ref}}$ could deliberately inflate $\hat{\sigma}$, widening the evasion margin before deploying the actual payload.
