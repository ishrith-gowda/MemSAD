...
In plain text-response mode, measured $\asra = 0.20$ under GPT-4o-mini is $3.4\times$ lower than the modelled $\asra = 0.68$~\citep{chen2024agentpoison}, reflecting production safety alignment (Figure~\ref{fig:measured_asr_a}, Appendix~\ref{app:additional_figures}); the tool-use setting raises $\asra$ to $0.48$ (Section~\ref{sec:experiments}, Table~\ref{tab:tool_agent}).
