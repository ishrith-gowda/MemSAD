...
STRIP~\citep{gao2019strip} and Neural Cleanse~\citep{wang2019neuralcleanse} are model-centric defenses requiring inference-time or white-box model access---inapplicable to write-time memory content where defenses target raw stored text rather than model weights or activations.
